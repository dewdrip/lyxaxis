...
- **Visitor Proposals:** Visitors can also make proposals to be signed by DAO managers.
...
- **Manage Digital Assets:** Display owned tokens and NFTs. DAO managers make proposals to manage the assets. e.g A manager can a proposal to deposit some USDC to AAVE. He specifies the AAVE contract address, function selector and arguments, and a detailed proposal description(with Markdown support). The rest of the managers sign it and it's executed through the multi-sig contract.
